...
We also visually compared students' observed (or actual) and their predict final grades, as in Figure 2. This helped us to see that while the model predicted the final grade accurately overall ($M_observed-final-grade$ = `r round(mean(data_test$final_grade), 3)`; $M_predicted-final-grade$ = `r round(mean(rf_pred), 3)`), the model predicted grades closer to the mean more frequently than as observed in the training data set and predicted very high grades less frequently than observed in the training data set.
