...
```
# 3. RESULTS 
The predictive accuracy of our random forest model was assessed by examining the difference between the __________
The variance explained by our random forest model was 57.54%. Below, we will discuss in detail the specific findings for each of our research questions, which concern the variable importance plots. Variable importance plots are interpreted based on the incremental percent change in mean-squared-error (MSE) if a given variable is scrambled in the original dataset ( ). In other words, variable importance plots help to answer the question

*Research Question 1*
With respect to research question 1, the variable importance plot for final grade indicated that the change in mean squared error

*Research Question 2*
    -With respect to research question 2, the most predictive motivation measure was _____
